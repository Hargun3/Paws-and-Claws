...
background.src = '../universal/f2bedroom2.png'; // Replace with the correct path to your background image
...
const obstacles = [
  {x: 1170, y: 30, width: 80, height: 250, color: 'rgba(255, 0, 0, ' + obstacles_opacity + ')'},
  {x: 1170, y: 420, width: 85, height: 111, color: 'rgba(255, 0, 0, ' + obstacles_opacity + ')'},
  {x: 240, y: 670, width: 105, height: 100, color: 'rgba(255, 0, 0, ' + obstacles_opacity + ')'},
  {x: 905, y: 570, width: 340, height: 200, color: 'rgba(255, 0, 0, ' + obstacles_opacity + ')'},
]
...
const objects = [
  ...
  { element: document.getElementById("object6"), brokenSrc: '../universal/broken-smolp.png', type: "break" },
  { element: document.getElementById("object10"), brokenSrc: '../universal/fish.png', type: "treat", visibility: treatVisibility },
  { element: document.getElementById("door"), isDoor: true, navigateTo: '../f2hallway/f2hallway.html'},
  { element: document.getElementById("door2"), isDoor: true, navigateTo: '../library/library.html'}
];
