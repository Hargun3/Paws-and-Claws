...
background.src = '../universal/library.png'; // Replace with the correct path to your background image
...
const obstacles = [
  ...
  {x: 782, y: 237, width: 120, height: 415, color: 'rgba(255, 0, 0, ' + obstacles_opacity + ')'},
]
...
const objects = [
  ...
  { element: document.getElementById("door2"), isDoor: true, navigateTo: '../f2bedroom2/f2bedroom2.html'}
];
